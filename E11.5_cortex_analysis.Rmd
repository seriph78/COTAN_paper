...
plot.heatmap(df_genes = list.genes,sets = c(1:3),conditions = "E11_cortex_clean",dir = "Data/")
```
## Heatmaps without cleaning
```{r}
list.genes = list("Ref.col"= PNGs, "NPGs"=NPGs, "Const."=hk )

plot.heatmap(df_genes = list.genes,sets = c(1:3),conditions = "E11_cortex",dir = "Data/")
```
