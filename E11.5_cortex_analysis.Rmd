...
```
```{r}
data = as.data.frame(fread(paste(data_dir,"GSM2861510_E115_Only_Cortical_Cells_DGE.txt.gz", sep = "/")))
...
obj = initRaw(obj,GEO="GSM2861510" ,sc.method="DropSeq",cond = "mouse cortex E11.5")
```
...
```{r}
obj2 = automatic.COTAN.object.creation(df = data,GEO="GSM2861510" ,sc.method="Drop-seq",cond = "E11_cortex",
                                       out_dir =  "Data/")
```
...
plot_heatmap(df_genes = list.genes,sets = c(1:3),conditions = "E11_cortex_clean",dir = "Data/")
```
## Heatmaps without cleaning
```{r}
list.genes = list("Ref.col"= PNGs, "NPGs"=NPGs, "Const."=hk )

plot_heatmap(df_genes = list.genes,sets = c(1:3),conditions = "E11_cortex",dir = "Data/")
```
