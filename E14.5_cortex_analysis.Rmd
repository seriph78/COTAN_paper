...
```{r}
data_dir = "Data/Mouse2/"
```
```{r}
data = as.data.frame(fread(paste(data_dir,"GSE123335_E14_combined_matrix.txt.gz", sep = "/")))
...
obj = initRaw(obj,GEO="GSE123335" ,sc.method="10X",cond = "mouse cortex E14.5")
```
...
plot_heatmap(df_genes = list.genes,sets = c(1:3),conditions = "E14_cortex",dir = "Data/")
```
