...
```{r}
gen.heatmap = plot.general.heatmap(prim.markers = c("Reln","Satb2","Sox5","Bcl11b"),dir = input_dir,condition = "E17_cortex_cl2",p_value = 0.001,symmetric = T)
```

```{r}
gen.heatmap = plot.general.heatmap(prim.markers = c("Reln","Satb2","Sox5","Bcl11b"),markers.list =c("Grm3","Abracl","Tox") ,dir = input_dir,condition = "E17_cortex_cl2",p_value = 0.001,symmetric = F)
```
...
all.genes.to.plot = c(pos.link.Bcl11b,pos.link.Reln,pos.link.Sox5,pos.link.Satb2)
