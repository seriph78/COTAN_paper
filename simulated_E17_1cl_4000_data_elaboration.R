...
data = as.data.frame(fread(paste0(data_dir,"simulated.dataset_E17_sqrt.fra.1cl_4000cs.csv.gz"),sep = ","))
...
obj = initRaw(obj,GEO="simulated" ,sc.method="dropSeq",cond = "SymE17_1cl_4000cs")
