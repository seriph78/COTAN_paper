...
Download the dataset for mouse dentate gyrus E16.5.
```{r}
...
```{r}
obj = readRDS("Data/E16.5_cleaned.cotan.RDS")
plot.GDI(obj, cond = "E16.5")
```
...
plot.heatmap(df_genes = list.genes,sets = c(1:3),conditions = "E16.5_cleaned",dir = "Data/")
```
