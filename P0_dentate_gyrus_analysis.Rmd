...
Download the dataset for mouse dentate gyrus P0.
```{r}
...
plot.heatmap(df_genes = list.genes,sets = c(1:3),conditions = "P0_dent_cleaned",dir = "Data/")
```
## Heatmaps without cleaning
```{r}
list.genes = list("Ref.col"= PNGs, "NPGs"=NPGs, "Const."=hk )

plot.heatmap(df_genes = list.genes,sets = c(1:3),conditions = "P0_dent_gyrus",dir = "Data/")
```
