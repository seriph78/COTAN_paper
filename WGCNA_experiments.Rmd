...
```{r}
select = which(colnames(datExpr0) %in% primary.markers )
...
# WGCNA with a sub-sample of genes

## Based on the mosto variable feature by Seurat
```{r}
number.var.genes =  round(dim(E17)[1]/10, digits = 0)
Var.genes = VariableFeatures(E17)[1:number.var.genes]
